        ...
        <div class="row">
            ...
            <div class="col-9">
                ...
                <form action="" method="POST">
                    ...
                    <label for="">Special Validity</label><br>
                    <input type="text" name="special_validity" placeholder="none" class="form-control col-6"><br><br>

                    <label for="">Maximun amount of tickets to be sold</label><br>
                    <input type="number" name="" placeholder="0" class="form-control col-6"><br><br>

                    <label for="">Tickets can be sold until</label><br>
                    <input type="date" name="date" class="form-control col-6"><br><br>
                    <div class="row">
                        <div class="col-6"><button class="btn btn-primary" type="submit">Save ticket</button></div>
