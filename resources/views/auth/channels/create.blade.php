        ...
        <div class="row">
            ...
            <div class="col-9">
                ...
                <form action="" method="POST">
                    ...
                    <input type="text" name="name" placeholder="Name channel"  class="form-control col-6"><br><br>
                    <div class="row">
                        <div class="col-6"><button class="btn btn-primary" type="submit">Save channel</button></div>
